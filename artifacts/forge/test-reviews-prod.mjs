...
page.on('requestfailed', (req) => errors.push({ type: 'REQFAIL', url: req.url(), reason: req.failure()?.errorText }));
...
await page.goto('http://localhost:4173/review', { waitUntil: 'networkidle' }).catch(e => console.log('nav error:', e.message));
