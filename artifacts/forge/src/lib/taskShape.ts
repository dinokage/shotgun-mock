...
// getProductionManagerApprovers/canApproveAsProductionManager were removed
// in migration 0023: they resolved who held the (now-deleted) separate
// production_head role, department by department. Admin is the studio's
// sole top role now and is studio-wide by nature, not department-assigned,
// so every call site now just checks `currentUser.role === "admin"` directly
// instead of calling into a department-fallback resolver.
