      ...
      <div className="flex-1 p-6 max-w-[1600px] w-full mx-auto">
        <Tabs defaultValue="dashboard" className="w-full h-full flex flex-col">
          <TabsList className="w-full justify-start border-b border-border rounded-none h-auto p-0 bg-transparent mb-6">
            ...
            <TabsTrigger value="playlists" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent px-4 py-2">Playlists</TabsTrigger>
          </TabsList>
          ...
          <div className="flex-1 min-h-0">
            ...
            <TabsContent value="playlists" className="h-full m-0 data-[state=active]:flex flex-col"><PlaylistsTab project={project} /></TabsContent>
          </div>
        </Tabs>
      </div>
    </div>
