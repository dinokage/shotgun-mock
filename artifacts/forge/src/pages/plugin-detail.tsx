...
import { ChevronLeft, Star, ShieldCheck, Download, CheckCircle2, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className="h-14 border-b border-border bg-card flex items-center px-4 shrink-0 gap-4">
        <Button variant="ghost" size="icon" asChild className="h-8 w-8 text-muted-foreground -ml-2">
          <Link href="/marketplace"><ChevronLeft className="w-5 h-5" /></Link>
        </Button>
        ...
        <div className="flex items-start gap-8">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-4xl font-bold tracking-tight">{plugin.name}</h1>
              {plugin.verified ? (
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1 font-bold text-xl">
                  {plugin.installs} <Download className="w-5 h-5 text-muted-foreground mb-0.5" />
                </div>
        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="col-span-2 space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <div className="w-1/2 aspect-video bg-muted rounded-lg border border-border flex items-center justify-center text-muted-foreground/30 font-medium">Screenshot 2</div>
            </div>
          </div>
            ...
            <Card>
              <CardContent className="p-4 space-y-4">
                ...
                <ul className="text-sm space-y-3 text-muted-foreground">
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-status-green shrink-0"/> Read asset metadata</li>
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-status-green shrink-0"/> Create new versions</li>
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-status-green shrink-0"/> Post comments on review sessions</li>
                  <li className="flex gap-2"><CheckCircle2 className="w-4 h-4 text-status-green shrink-0"/> Access render logs</li>
                </ul>
              </CardContent>
            </Card>
          </div>
