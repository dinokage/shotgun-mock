  ...
  useEffect(() => {
    if (params?.role) {
      const roleToEmail: Record<string, string> = {
        ...
        producer: "producer@acme.com",
        manager: "manager@acme.com",
        lead: "lead@acme.com",
        artist: "artist@acme.com",
      ...
      <div className="w-full max-w-4xl relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-muted-foreground text-lg">
            {params?.role
              ? `Sign in as ${params.role.charAt(0).toUpperCase() + params.role.slice(1)}`
            ...
            {portalCards.map((portal) => (
              <Link key={portal.role} href={`/login/${portal.role}`}>
                <div
                  ...
                  style={{
                    animationDelay: `${portal.delay}ms`,
