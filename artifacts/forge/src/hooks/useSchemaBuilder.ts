...
export function useCreateEntityField() {
  ...
  return useMutation({
    mutationFn: ({
      entityTypeId,
      ...body
    }: { entityTypeId: string } & EntityFieldInput) =>
      apiClient.post<EntityField>(
        `/schema/entity-types/${entityTypeId}/fields`,
        body,
      ),
    onSuccess: () =>
      queryClient.invalidateQueries({ queryKey: ENTITY_TYPES_KEY }),
...
export function useReorderEntityFields() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiClient.put<EntityTypeDef>(
        `/schema/entity-types/${entityTypeId}/fields/order`,
        {
          fieldIds,
        },
      ),
...
export function useDeleteTaskTemplate() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      apiClient.delete(`/schema/task-templates/${id}`),
    onSuccess: () =>
      queryClient.invalidateQueries({ queryKey: TASK_TEMPLATES_KEY }),
  });
}
...
export function useDuplicateTaskTemplate() {
  ...
  return useMutation({
    mutationFn: (id: string) =>
      apiClient.post<TaskTemplateDef>(
        `/schema/task-templates/${id}/duplicate`,
        {},
      ),
    onSuccess: () =>
      queryClient.invalidateQueries({ queryKey: TASK_TEMPLATES_KEY }),
...
export function useCreateTemplateItem() {
  ...
  return useMutation({
    mutationFn: ({
      templateId,
      ...body
    }: { templateId: string } & TaskTemplateItemInput) =>
      apiClient.post<TaskTemplateItem>(
        `/schema/task-templates/${templateId}/items`,
        body,
      ),
    onSuccess: () =>
      queryClient.invalidateQueries({ queryKey: TASK_TEMPLATES_KEY }),
...
export function useReorderTemplateItems() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiClient.put<TaskTemplateDef>(
        `/schema/task-templates/${templateId}/items/order`,
        {
          itemIds,
        },
      ),
